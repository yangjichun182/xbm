...
<script type="text/javascript" src="/pactera/ajax/03_ajax_register/register.js">
			...
			<table border="1">
				<tr>
					...
					<td><input type="text" name="username" value="" id="username">
						<div id="divcheck"></div> <input type="button" name="checkusername" value="查看用户名" id="checkusername"></td>
				</tr>
				<tr>
					<td>密码:</td>
